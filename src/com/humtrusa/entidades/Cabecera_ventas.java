...
public class Cabecera_ventas {
    ...
    public Cabecera_ventas(Long id_cabecera_venta, String mun_venta, Long id_cliente, Long id_usuario, Long id_empresa, Date fecha_venta, String forma_de_pago, String tipo_de_venta, BigDecimal subtotal_con_iva, BigDecimal subtotal_sin_iva, BigDecimal subtotal_no_obj_iva, BigDecimal subtotal_exento_iva, BigDecimal subtotal_venta, BigDecimal ice_venta, BigDecimal descuento_venta, BigDecimal iva_venta, BigDecimal total_venta, BigDecimal utilidad, String estado) {
