 ...
 * @author usuario
 */
public class Medidas_productos extends javax.swing.JDialog {
    ...
    Medidas_producto objeto = null;
    public Medidas_productos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Tablas.listarComponenteMedidaProducto(listaMedida,jTable1);
    }
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
       int i=0;
        if (evt.getClickCount() == 2) {
            ...
            objeto = devuelveObjeto(jTable1.getValueAt(i, 0).toString(), listaMedida);
            if (objeto != null) {
                EdicionComponentes Man = new EdicionComponentes(new javax.swing.JFrame(), true,objeto,3);
    ...
    public Medidas_producto devuelveObjeto(String datos, ArrayList<Medidas_producto> listarobj) {
        Medidas_producto objeto1 = null;
        for (int i = 0; i < listarobj.size(); i++) {
            if (datos.equals(listarobj.get(i).getId_medida().toString())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medidas_productos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Medidas_productos dialog = new Medidas_productos(new javax.swing.JFrame(), true);
