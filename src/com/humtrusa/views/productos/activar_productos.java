 ...
 * @author usuario
 */
public class activar_productos extends javax.swing.JDialog {
    ...
    public activar_productos(java.awt.Frame parent, boolean modal, JoinProductos obj1) {
        super(parent, modal);
        initComponents();
    ...
    public void llamarProductosInactivos(){
        this.dispose();
        productosInactivos pi = new productosInactivos(new javax.swing.JFrame(),true);
        pi.setVisible(true);
    }
    ...
    private void btnInactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInactivarActionPerformed
        int r = JOptionPane.showConfirmDialog(null, "¿Desea Activar el Producto "+obj.getNombre()+" ?", "", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(activar_productos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                activar_productos dialog = new activar_productos(new javax.swing.JFrame(), true);
