 ...
 * @author usuario
 */
public class Agregar_Tipo_producto extends javax.swing.JDialog {

    CRUD crud = new CRUD();
    private final Color color = new Color(63, 63, 220);
    
    public Agregar_Tipo_producto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Tipo_producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Agregar_Tipo_producto dialog = new Agregar_Tipo_producto(new javax.swing.JFrame(), true);
